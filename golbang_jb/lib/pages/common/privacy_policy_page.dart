...
'''),
          Section(title: '2. 개인정보 수집 및 이용 목적', content: '''
...
- 법령에서 요구하는 기록 보관.
'''),
          Section(title: '3. 회원 탈퇴 및 개인정보 처리', content: '''
...
'''),
          Section(title: '4. 개인정보 보관 기간', content: '''
...
- 회원 탈퇴 요청
'''),
          Section(title: '8. 개인정보 보호를 위한 기술적/관리적 조치', content: '''
개인정보 보호를 위해 다음과 같은 조치를 취하고 있습니다.
- 데이터 암호화
- 접근 통제
- 보안 점검
'''),
          Section(title: '9. 문의 및 정보 보호 책임자', content: '''
개인정보 보호 책임자: [담당자 이름]
연락처: support@golfmoim.com
전화번호: 02-123-4567
'''),
        ],
      ),
