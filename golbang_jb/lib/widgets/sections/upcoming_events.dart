...
//                 width: 230,  // 박스 너비 줄임
//                 height: 100, // 박스 높이 줄임
//                 margin: const EdgeInsets.symmetric(vertical: 4, horizontal: 8),  // 상하좌우 여백 최소화
//                 padding: const EdgeInsets.all(6),  // 내부 여백 더 줄임
//                 decoration: BoxDecoration(
//                   color: Colors.white,
//                   border: Border.all(
//                     color: _getBorderColor(statusType),
...
//                 ),
//                 child: ListTile(
//                   contentPadding: const EdgeInsets.symmetric(horizontal: 4, vertical: 2),  // 내부 패딩 줄임
//                   title: Column(
//                     crossAxisAlignment: CrossAxisAlignment.start,
//                     children: [
//                       Row(
...
//                         style: const TextStyle(
//                           fontWeight: FontWeight.bold,
//                           fontSize: 12,  // 날짜 글씨 크기 줄임
//                         ),
//                       ),
//                       Text(
//                         '장소: ${event.site}',
//                         style: const TextStyle(fontSize: 12),  // 장소 글씨 크기 줄임
//                       ),
//                       Row(
//                         children: [
//                           const Text(
//                             '참석 여부: ',
//                             style: TextStyle(fontSize: 12),  // 참석 여부 텍스트 크기 줄임
//                           ),
//                           _buildStatusButton(statusType, event),
//                         ],
//                       ),
...
//       style: ElevatedButton.styleFrom(
//         backgroundColor: color,
//         minimumSize: const Size(40, 28),  // 버튼 크기 줄임
//         shape: RoundedRectangleBorder(
//           borderRadius: BorderRadius.circular(10.0),
//         ),
//       ),
//       child: Text(
//         _getStatusText(status),
//         style: const TextStyle(fontSize: 10, color: Colors.white),  // 버튼 텍스트 크기 줄임
//       ),
//     );
//   }
//
