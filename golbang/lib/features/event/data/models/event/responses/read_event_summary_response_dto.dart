...
class ReadEventSummaryResponseDto {
  final ClubProfileDto club;
  final int eventId;
  ...
  factory ReadEventSummaryResponseDto.fromJson(Map<String, dynamic> json) {
    return ReadEventSummaryResponseDto(
      club: json['club'],
